@meryem8a
Feature: Bireysel Contact Form Submission with Invalid Email Address
  ...
  Scenario: User_Receives_Warning_for_Email_Address_with_Space_Characters
    ...
    #And an email address containing space characters is entered in the 'E-Posta Adresiniz' field

@meryem2a
  Feature: Bireysel Contact Form Submission with Blank name field
    ...
    Scenario: Unsuccessful_Submission_with_Blank_'Adiniz'_Field
      ...
      Then the user verifies that they receive a warning message "Lütfen adınızı giriniz." under the 'Adiniz' field